...
export default function Home() {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center p-4">
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-12 max-w-md w-full text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">Welcome to Aurada!</h2>
          ...
          <button 
            ...
            className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-3 rounded-xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 font-medium"
          >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-20">
            <div className="flex items-center justify-center mb-12">
              ...
              />
              <div className="w-px h-20 bg-gradient-to-b from-cyan-500 to-blue-500 mr-8"></div>
              <p className="text-3xl text-gray-300 font-light tracking-wide">Speak. Text. Serve.</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-10 py-4 rounded-xl text-lg font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Start Your Pilot
              </button>
              <button className="border border-white/20 text-white px-10 py-4 rounded-xl text-lg font-semibold hover:bg-white/5 transition-all duration-300">
                Watch Demo
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-center">
              <div className="text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-2">30-40%</div>
              <p className="text-gray-300">of phone orders lost</p>
            </div>
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-center">
              <div className="text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-2">$129</div>
              <p className="text-gray-300">per location/month</p>
            </div>
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-center">
              <div className="text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-2">8-15x</div>
              <p className="text-gray-300">projected ROI</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Staffing & Cost Struggles</h3>
              <p className="text-gray-300 leading-relaxed">High labor costs and constant staff shortages impact your bottom line daily.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Lost Phone Orders</h3>
              <p className="text-gray-300 leading-relaxed">You&apos;re losing 30-40% of phone orders, especially during busy times, due to unanswered calls.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Lack of Data Visibility</h3>
              <p className="text-gray-300 leading-relaxed">Operating without clear data on call volume, lost orders, or upsell success hinders improvement.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Failing Solutions</h3>
              <p className="text-gray-300 leading-relaxed">Existing solutions are often too expensive, slow, or unsuited for busy restaurant needs.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            <div className="bg-white/5 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">AI Call & Text Ordering</h3>
              <p className="text-gray-300 leading-relaxed">Real-time order handling via voice/SMS with immediate confirmation and secure payment links.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Full POS Integrations</h3>
              <p className="text-gray-300 leading-relaxed">Seamless connection with Toast, Square, PAR, and Olo systems.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Smart Upsell Engine</h3>
              <p className="text-gray-300 leading-relaxed">Increases average order value by 15-25% through intelligent recommendations.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-semibold text-white mb-4">Call Analytics Dashboard</h3>
              <p className="text-gray-300 leading-relaxed">Weekly metrics on orders, missed calls, upsell success, and customer retention.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Signup Form */}
      <section id="signup-form" className="py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                <h4 className="text-2xl font-semibold text-white mb-8">Restaurant Information</h4>
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-4 bg-white/5 border border-white/20 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white backdrop-blur-xl transition-all duration-300"
                    >
              ...
              {/* Owner Information */}
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                <h4 className="text-2xl font-semibold text-white mb-8">Owner Information</h4>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                <h4 className="text-2xl font-semibold text-white mb-8">Business Information</h4>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
